...
c ===========================================================================
  100100     1  -10.5     -100 106 -20    imp:n=1 u=100 $ Meat
  100101     2  -6.55     -102 105 21 -22 imp:n=1 u=100 $ Cladding
  100102     2  -0.000001 -100 106 20 -21 imp:n=1 u=100 $ Gas Gap
  ...
  100113     2  -0.000001  100 -102 -21   imp:n=1 u=100 $ UpperGas Gap
  100114     3  -0.777537 -105 106 22     imp:n=1 u=100 $ Water radially around 100110
c ***************************************************************************
c *Cell being filled
c ***************************************************************************
 1001     0         -10001 -40 41  fill=100
 1002     2         -10002 10001 -42 43 imp:n=0
c ===========================================================================
...
c Planes for core boundaries
  ...
  42    pz     950.0                   $ GRAVE top
  43    pz    -250.0                   $ GRAVE bottom
c ===========================================================================
